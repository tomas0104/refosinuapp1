...
/***/ "Zwmr":
/*!**************************************************!*\
  !*** ./src/app/services/service-todo.service.ts ***!
  \**************************************************/
/*! exports provided: ServiceTodoService */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ServiceTodoService", function() { return ServiceTodoService; });
...
let ServiceTodoService = class ServiceTodoService {
    constructor(db) {
        this.encuestaCollection = db.collection('encuesta');
        this.encuesta = this.encuestaCollection.snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(actions => {
    ...
    getEncuesta(id) {
        return this.encuestaCollection.doc(id).valueChanges();
    }
    addEncuestas(encuesta) {
...
ServiceTodoService.ctorParameters = () => [
    { type: _angular_fire_firestore__WEBPACK_IMPORTED_MODULE_2__["AngularFirestore"] }
];
ServiceTodoService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
